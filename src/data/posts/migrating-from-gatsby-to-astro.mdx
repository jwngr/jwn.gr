...
- **Framework flexibility:** The ability to fall back to React (or other frameworks) when needed
  ...
  [newsletter signup form](https://github.com/jwngr/jwn.gr/blob/main/src/components/blog/NewsletterSignupForm.tsx),
...
3. **Lack of multiple exports from `.astro` files:** This limitation led to some code organization
   ...
   [`Flex` component](https://github.com/jwngr/jwn.gr/blob/main/src/components/atoms/Flex.astro)
